      ...
      <div className="relative max-w-content mx-auto px-5 sm:px-8
        ...
        >
          ...
          <p className="eyebrow text-orange-600 mb-4 flex items-center gap-2">
            ...
            Лидер в здравето и благополучието
          </p>

          {/* Заглавие */}
          <h1 className="font-serif font-semibold text-green-900 mb-5
          ...
          <div className="flex flex-wrap gap-3 mb-9">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 border border-green-600
                         ...
                         text-[13.5px] px-6 py-3 rounded-pill transition-colors duration-200"
            >
              Виж продуктите
          ...
          {/* Trust badges */}
          <ul className="flex flex-wrap gap-x-5 gap-y-2" aria-label="Ключови факти">
            {BADGES.map(({ icon, text }) => (
              <li key={text}
                  className="flex items-center gap-1.5 font-sans text-[12px]
                             font-medium text-neutral-500">
                <span className="text-gold-400 text-[10px]" aria-hidden="true">{icon}</span>
                {text}
              </li>
            ))}
          </ul>
