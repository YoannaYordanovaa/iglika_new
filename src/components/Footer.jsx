  ...
  return (
    <footer className="bg-green-900 text-white">
      ...
      <div className="max-w-content mx-auto px-5 sm:px-8 py-10
        ...
        <div>
          <Link to="/" className="inline-block mb-3">
            ...
            <p className="font-sans text-[10.5px] font-medium uppercase tracking-[0.12em]
                          text-white/40 mt-0.5">
              Здраве · Успех
            </p>
          </Link>
          <p className="font-sans text-[13px] text-white/50 leading-[1.75] max-w-[24ch]">
            Помагам на хора да открият по-здравословен начин на живот и нови възможности.
          </p>
        </div>

        {/* Навигация */}
        <div>
          <p className="font-sans text-[11px] font-semibold uppercase tracking-[0.1em]
                        text-white/40 mb-4">
            Навигация
          </p>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-content mx-auto px-5 sm:px-8 py-5
          ...
          <p className="font-sans text-[12px] text-white/25">
            Forever Living Products дистрибутор
          </p>
        </div>
      </div>
