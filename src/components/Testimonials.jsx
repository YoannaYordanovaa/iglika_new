...
const TESTIMONIALS = [
  ...
  },
  {
  ...
  },
   {
    ...
    initials: 'ТК',
    color: 'bg-gold-50 text-gold-800',
    text: 'Игличето е от хора, които са тук, за да ни напомнят, че има Ангели около нас на които можем да разчитаме ВИНАГИ.',
  },
   {
    name: 'Мая Сидерова',
    initials: 'МС',
    color: 'bg-gold-50 text-gold-800',
    text: 'Аз съм в екипа на Иглика, защото се уча от нея на живот. Уроците по живот се преподават в много книги и семинари, но се научават най-добре чрез живота и ежедневно общуване с качествени хора като Иглика. Благодарение на Форевър това е част от работата ни, което прави тези ценни срещи регулярни. По този начин около нея се събира екип от стойностни хора от които постоянно черпя знания, опит и идеи за по-добър живот. ',
  },
]
