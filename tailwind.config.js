...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-xl': ['3.25rem',  { lineHeight: '1.15', letterSpacing: '-0.01em', fontWeight: '600' }],
        'display-lg': ['2.5rem',   { lineHeight: '1.2',  letterSpacing: '-0.01em', fontWeight: '600' }],
        'display-md': ['1.875rem', { lineHeight: '1.3',  letterSpacing: '0',       fontWeight: '600' }],
        'display-sm': ['1.375rem', { lineHeight: '1.35', letterSpacing: '0',       fontWeight: '600' }],
